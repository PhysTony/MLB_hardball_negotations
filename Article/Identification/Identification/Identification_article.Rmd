...
for (i in 1:4) {
  ...
  hitter_simple_stimation_1[[length(hitter_simple_stimation_1) + 1]] <- plm(formula,
                                                                            data = data_list[[i]],
                                                                            model = model_list[[i]],
                                                                            index = c("id", "Anio_ref"))
 ...
 # hitter_results_stimation_3 <- coeftest(hitter_stimation_3,
  ...
  #hitter_simple_results_list[[paste(name_list[[i]], model_list[[i]])]] <- robust_se
}

# Print the third block of results
stargazer(hitter_simple_results_list,
         no.space = TRUE,
         align = TRUE,
         type = "text",
