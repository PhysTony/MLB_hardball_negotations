...
hitters_panel <- read.csv('ETL_Data/Panel/Cumulative/Dynamic_model/panel_hitters_cum_t_1.csv')
fielders_panel <- read.csv('ETL_Data/Panel/Cumulative/Dynamic_model/panel_fielders_cum_t_1.csv')
```
...
```{r starting_stimation}
# loop over the variables in var_hitter_list
for (i in 1:length(cum_fielder)){
