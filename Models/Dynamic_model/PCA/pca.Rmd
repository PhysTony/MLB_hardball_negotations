...
hitter_pca_models <- list(hitter_results_simple_pooling_pca,
                       hitter_results_simple_within_pca,
                       hitter_results_simple_random_pca,
                       hitter_results_simple_fd_pca)
...
fielder_pca_models <- list(fielder_results_simple_pooling_pca,
                           fielder_results_simple_within_pca,
                           fielder_results_simple_random_pca,
                           fielder_results_simple_fd_pca)
...
stargazer(fielder_pca_models,
          ...
          column.labels = c("Pooling", "Within", 
                            "RE","FD"),
          covariate.labels = c("Edad$_{t}$" , "Años contrato$_{t}$", "Eqipo$_{t}$",
                               "PCA$_{1_{t}}$", "PCA$_{2_{t}}$",
                               "PCA$_{1_{t-1}}$","PCA$_{2_{t-1}}$",
                               "Agente$_{t}$"))
```
