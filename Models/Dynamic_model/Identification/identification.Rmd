...
setwd("~/Documents/Github/MLB_hardball_negotations/")
...
# Estimaciones directas - Identificación
...
```{r starting_stimation_fd, echo=FALSE, eval=TRUE}
# Create a model to store the results
...
```{r hitter_stimation_ecom, echo=FALSE, eval=TRUE}
# Significant variables:
# Pooling:
hitter_vars_1 <- c("X_Triples_t_1",
                    "X_WAR_t")
...
stargazer(hitter_models,
         ...
         column.labels = c("Pooling", "Within", 
                           "Efecto Aleatorios","First-Differences"),
         covariate.labels = c("$Edad_{t}$" , "Años contrato$_{t}$", "Eqipo$_{t}$", 
                              "$X_{T_{t-1}}$",
                              "$X_{AB_{t}}$", "$X_{AB_{t-1}}$",
                              "$X_{H_{t}}$", "$X_{H^{2}_{t-1}}$",
                              "$X_{GS_{t}}$","$X_{GS_{t-1}}$",
                              "$X_{OPS_{t-1}}$",
                              "$X_{OBP_{t-1}}$", "$X_{OBP^{2}_{t}}$",
                              "$X_{T_{t}}$","$X_{T^{2}_{t}}$", 
                              "$X_{WAR_{t}}$", 
                              "$X_{WAR_{t-1}}$", "$X_{WAR^{2}_{t}}$", 
                              "$X_{HR_{t-1}}$",
                              "$X_{RBI_{t-1}}$",
                              "Agente$_{t}$"))
```
...
```{r fielder_stimation_pooling_2, echo=FALSE, eval=TRUE}
# Significant variables:
...
stargazer(fielder_models,
         ...
         covariate.labels = c("$Edad_{t}$" , "Años contrato$_{t}$", "Eqipo$_{t}$", 
                              ...
                              "$X_{H^{2}_{t}}$","$X_{H^{2}_{t-1}}$",
                              "$X_{H{t}}$","$X_{ER^{2}_{t}}$",
                              "$X_{Dominio_{t-1}}$", "$X_{IP^{2}_{t}}$",
                              "$X_{L^{2}_{t-1}}$","$X_{ERA_{t-1}}$",
                              "$X_{R_{t}}$","$X_{Comando^{2}_{t-1}}$",
                              "$X_{Comando_{t}}$","$X_{Comando_{t-1}}$",
                              "$X_{Control^{2}_{t-1}}$","$X_{Control_{t-1}}$",
                              "$X_{Dominio^{2}_{t}}$","$X_{Dominio_{t}}$",
                              "$X_{Dominio^{2}_{t-1}}$","$X_{ERA_{t}}$",
                              "$X_{S^{2}_{t}}$","$X_{S^{2}_{t-1}}$",
                              "$X_{S_{t}}$","$X_{S_{t-1}}$",
                              "$X_{SO^{2}_{t-1}}$","$X_{SO_{t}}$",
                              "$X_{SO_{t-1}}$",
                              "$X_{WAR^{2}_{t-1}}$","$X_{WAR^{2}_{t}}$",
                              "$X_{BB^{2}_{t}}$","$X_{BB_{t}}$",
                              "Agente$_{t}$"))
```
